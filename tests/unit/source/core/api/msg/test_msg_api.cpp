...
class TestMsgApi : public testing::Test
{
    protected:
...
TEST_F(TestMsgApi, singleMsgApiTest)
{
    ...
    /**
     * -------------------------------------------------------------------------
     * [TEST CASE] make sure the msg size is correct
     * -------------------------------------------------------------------------
     **/

    EXPECT_EQ(sizeof(msg_t), sizeof(Msg));
    ...
    EXPECT_EQ(msg_send(&msg, idle_thread->get_pid()), -1);
    EXPECT_EQ(msg_send(&msg, idle_thread->get_pid()), -1);
    EXPECT_EQ(msg_send(&msg, idle_thread->get_pid()), -1);
    EXPECT_EQ(msg_send(&msg, idle_thread->get_pid()), -1);
    ...
    EXPECT_EQ(msg_send(&msg2, thread1->get_pid()), 1);
    ...
    EXPECT_EQ(msg_send(&msg3, main_thread->get_pid()), 1);
    ...
    EXPECT_EQ(msg_try_send(&msg3, main_thread->get_pid()), 1);
    ...
    EXPECT_EQ(msg_send(&msg3, thread1->get_pid()), 1);
    ...
    EXPECT_EQ(msg_send_receive(&msg3, &msg4, main_thread->get_pid()), 1);
    ...
    EXPECT_EQ(msg_reply(&msg5, &msg6), 1);
    ...
    EXPECT_EQ(msg_reply_in_isr(&msg5, &msg6), 1);
...
TEST_F(TestMsgApi, multipleMsgApiTest)
{
    ThreadScheduler *scheduler = &ThreadScheduler::init();
    ...
    EXPECT_EQ(msg_send(&msg1, thread1->get_pid()), 1);
    EXPECT_EQ(msg_send(&msg2, thread1->get_pid()), 1);
    EXPECT_EQ(msg_send(&msg3, thread1->get_pid()), 1);
    EXPECT_EQ(msg_send(&msg4, thread1->get_pid()), 1);
    ...
    EXPECT_EQ(msg_send(&msg6, thread1->get_pid()), 1);
    ...
    EXPECT_EQ(msg_try_send(&msg6, thread1->get_pid()), 0);
    EXPECT_EQ(msg_try_send(&msg6, thread1->get_pid()), 0);
    EXPECT_EQ(msg_try_send(&msg6, thread1->get_pid()), 0);
    EXPECT_EQ(msg_try_send(&msg6, thread1->get_pid()), 0);
    EXPECT_EQ(msg_try_send(&msg6, thread1->get_pid()), 0);
    ...
    EXPECT_EQ(msg_send_to_self_queue(&msg6), 1);
